...
<qgis labelsEnabled="0" version="3.22.10-Białowieża" styleCategories="Symbology|Labeling|Legend">
      ...
      <symbol name="0" type="fill" force_rhr="0" clip_to_extent="1" alpha="1">
        ...
        <layer enabled="1" locked="0" class="SimpleFill" pass="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="156,143,1,88"/>
